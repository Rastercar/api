...
export class Migration20220204043151 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "user" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "username" varchar(255) not null, "last_login" timestamptz(0) null, "email" varchar(255) not null, "email_verified" bool not null default false, "password" varchar(255) not null, "oauth_provider" varchar(255) null, "oauth_profile_id" varchar(255) null, "organization_id" int4 not null);'
    )
