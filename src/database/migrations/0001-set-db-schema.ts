...
export class SetDbSchema extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "user" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "username" varchar(255) not null, "last_login" timestamptz(0) null, "email" varchar(255) not null, "email_verified" boolean not null default false, "password" varchar(255) not null, "reset_password_token" varchar(255) null, "google_profile_id" varchar(255) null, "organization_id" int not null, "access_level_id" int not null);');
    ...
    this.addSql('create table "master_user" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "username" varchar(255) not null, "last_login" timestamptz(0) null, "email" varchar(255) not null, "email_verified" boolean not null default false, "password" varchar(255) not null, "reset_password_token" varchar(255) null, "access_level_id" int null, "master_access_level_id" int not null);');
