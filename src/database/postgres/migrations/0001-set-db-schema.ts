...
export class SetDbSchema extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "tracker" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "model" varchar(255) not null, "identifier" varchar(255) not null, "in_maintenance" boolean not null default false, "organization_id" int not null, "vehicle_id" int null);');
    this.addSql('alter table "tracker" add constraint "tracker_identifier_unique" unique ("identifier");');

    this.addSql('create table "sim_card" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "phone_number" varchar(255) not null, "ssn" varchar(255) not null, "apn_address" varchar(255) not null, "apn_user" varchar(255) not null, "apn_password" varchar(255) not null, "pin" varchar(8) null, "pin2" varchar(8) null, "puk" varchar(8) null, "puk2" varchar(8) null, "organization_id" int not null, "tracker_id" int null);');
